...
The paper describes a second way to measure a trailhead called its **rating**. A trailhead's rating is the **number of distinct hiking trail**s which begin at that trailhead. For example:
